    ...
    axios.get(`http://localhost:7000/getproduct?category=${category}`, {
        ...
        .then((resp) => {
            ...
            resp.data.data.forEach(function (data) {
                ...
                <div class="box">                
                    <button class="btn" onclick="deleteProduct('${data._id}')"><i class="fa-solid fa-delete-left"></i></button>
                    <button class="btn" onclick="getEmailInInput('${data._id}','${data.productPrice}','${data.productName}','${data.categoryName}','${data.discription}')"><i class="fa-solid fa-pen-to-square"></i></button>
                </div>
                </div>
            `;
...
const getEmailInInput = (id, price, name, category) => {
    ...
    <div class="admin-form">
        ...
        <input type="text"  value=${discription}  placeholder="category name" id="discription1"><br>
...
const updateProduct = (id) => {
    ...
    const discription = document.querySelector("#discription1").value;
